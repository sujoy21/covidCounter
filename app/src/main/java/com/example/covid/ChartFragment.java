            ...
            public void onResponse(Call<Response> call, retrofit2.Response<Response> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    for(CasesTimeSeries obj : list){
                        ...
                        String cnfrmd = obj.getDailyconfirmed();
                        int dat = Integer.parseInt(date.replaceAll("[^0-9]",""));
                        int cnf = Integer.parseInt(cnfrmd.replaceAll("[^0-9]",""));
                        barEntries.add(new BarEntry(dat,cnf));
                        //barEntries.add(new BarEntry(20,50));
                    }

                    BarDataSet barDataSet = new BarDataSet(barEntries,"Daily Confirmed");
