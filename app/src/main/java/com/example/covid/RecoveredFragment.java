 ...
 * Use the {@link RecoveredFragment#newInstance} factory method to
...
public class RecoveredFragment extends Fragment {
     ...
     * @return A new instance of fragment RecoveredFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static RecoveredFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_recovered, container, false);

        mBarChart = view.findViewById(R.id.barChart3);
            ...
            public void onResponse(Call<Response> call, retrofit2.Response<Response> response) {
                if(response.isSuccessful()){
                    ...
                    for(CasesTimeSeries obj : list){
                        ...
                        String rcvd = obj.getDailyrecovered();
                        int dat = Integer.parseInt(date.replaceAll("[^0-9]",""));
                        int rcv = Integer.parseInt(rcvd.replaceAll("[^0-9]",""));
                        barEntries.add(new BarEntry(dat,rcv));
                        //barEntries.add(new BarEntry(20,50));
                    }

                    BarDataSet barDataSet = new BarDataSet(barEntries,"Daily Recovered");
